            ...
            <header class="main-header">
                ...
                <div class="header-top fl-wrap">
                    <div class="container">
                        ...
                        <div class="lang-wrap">
                            <div class="show-lang"><img src="assets/images/lan/1.png" alt=""> <span>Eng</span><i class="fa fa-caret-down"></i></div>
                            <ul class="lang-tooltip green-bg">
                                <li><a href="#"><img src="assets/images/lan/4.png" alt=""> De</a></li>
                                <li><a href="#"><img src="assets/images/lan/5.png" alt=""> It</a></li>
                                <li><a href="#"><img src="assets/images/lan/2.png" alt=""> Fr</a></li>
                                <li><a href="#"><img src="assets/images/lan/3.png" alt=""> Es</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container"> 
                        <div class="header-user-menu">
                            <div class="header-user-name">
                                <span><img src="assets/images/avatar/1.jpg" alt=""></span>
                                My account
                            </div>
                            <ul>
